    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith(".csv"):
            ...
            if animation is not None:
                try:
                    blended = blend_animation_start_end(
                        animation, blend_frames=blend_frames
                    )
...
emotion_paths = {
    "Angry": os.path.join(mod_path, "Angry"),
    "Disgusted": os.path.join(mod_path, "Disgusted"),
    "Fearful": os.path.join(mod_path, "Fearful"),
    "Happy": os.path.join(mod_path, "Happy"),
    "Neutral": os.path.join(mod_path, "Neutral"),
    "Sad": os.path.join(mod_path, "Sad"),
    "Surprised": os.path.join(mod_path, "Surprised"),
}
...
for emotion, folder in emotion_paths.items():
    ...
    print(
        f"Loaded {len(emotion_animations[emotion])} animations for emotion '{emotion}'"
    )
